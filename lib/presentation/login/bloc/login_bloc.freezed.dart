...
abstract class _Submitted implements LoginEvent {
  factory _Submitted() = _$SubmittedImpl;
}
...
class _$LoginStateImpl implements _LoginState {
  ...
  @override
  String toString() {
    return 'LoginState(email: $email, password: $password, errorMessage: $errorMessage, status: $status)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, email, password, errorMessage, status);
...
abstract class _LoginState implements LoginState {
  const factory _LoginState(
      ...
      final String password,
      final String? errorMessage,
      final LoginStatus status}) = _$LoginStateImpl;
...
class __$$SubmittingImplCopyWithImpl<$Res>
    extends _$LoginStatusCopyWithImpl<$Res, _$SubmittingImpl>
...
abstract class _Submitting implements LoginStatus {
